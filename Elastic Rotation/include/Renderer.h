...
namespace midl {
	...
	private:
		// GL Model space to Screen space variables
		float prj_right, prj_left, prj_top, prj_bottom, prj_near, prj_far;
	...
	public:
		...
		void SetParameters(float prj_right, float prj_left, float prj_top, float prj_bottom, float near prj_near, float far prj_far);
